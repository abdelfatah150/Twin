...
import Header from '../Components/shared_profile_header';
  ...
  projects: [
    {
      title: "Taskflow",
      description:
        "A task management system that helps teams collaborate efficiently by organizing tasks, setting deadlines, and tracking progress in real-time",
      review:
        "Great experience working with this developer! The project was delivered on time, and the backend is fast and reliable. Would definitely collaborate again! - Ahmed R",
      rating: 4,
      track: 'Full-Stack',
    },
    {
...
const SharedDeveloperProfile: React.FC = () => {
        ...
        <div className="profile-container">
          ...
          <main className="profile-content">
            <div className="business-section">
              <h3 className="section-title">{profileData.track}</h3>
...
export default SharedDeveloperProfile;
